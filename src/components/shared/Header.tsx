  ...
  return (
    <div className=" flex  justify-between xl:pb-12 pb-4 sm:py-8 flex-col-reverse text-[white] lg:flex-row items-center bg-[#31688F] dark:bg-inherit sm:px-16 mt-[52px] py-14 px-8">
      <div>
        ...
        <p className="md:text-[20px] text-[14px] mt-4 text-center lg:text-left font-thin leading-7 opacity-90">
        ...
        <div className="flex justify-between my-6 md:w-[80%] m-auto flex-col md:flex-row space-y-4 md:space-y-0   lg:w-[100%] w-[100%] md:space-x-4 space-x-0 items-center">
          <Button className="hover:scale-110 transition-all duration-300 rounded-3xlpy-[7px] w-[220px] bg-[#FFDE31] hover:bg-[#FFDE31] text-black font-[600] rounded-3xl">

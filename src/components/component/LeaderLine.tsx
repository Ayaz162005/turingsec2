    ...
    <div className="border-2 rounded-full border-[#023059] bg-[#023059] lg:px-8 px-4 flex items-center justify-between hover:scale-105 cursor-pointer transition-all duration-300">
      ...
      <div className="flex items-center justify-between lg:w-1/2 md:w-[60%] ">
        <div className="md:flex items-center justify-between w-full  hidden">
          <div>
            <p className="text-[#FFEC86]">Apr</p>
            <p className=" text-[22px]">65</p>
          </div>
          <div>
            <p className="text-[#FFEC86]">May</p>
            <p className=" text-[22px]">65</p>
          </div>
          <div>
            <p className="text-[#FFEC86]">Jun</p>
            <p className=" text-[22px]">65</p>
          </div>
          <div>
            <p className="text-[#FFEC86]">Apr</p>
        ...
        <div className="bg-[#FFDE31] rounded-xl text-black px-3  py-[2px] sm:px-4 font-medium sm:text-[25px] text-[18px] lg:ml-12 sm:ml-4 ml-4 sm:mr-4 mr-2">
          61
        </div>
        <button className="text-[2px] min-w-8">
          <img src="/assets/images/newnext.svg" alt="" />
        </button>
      </div>
    </div>
  );
